...
namespace ASP.NETCoreIdentityCustom.Migrations
{
    ...
    [Migration("20221205235135_changeTeacher")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP.NETCoreIdentityCustom.Models.Domaine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASP.NETCoreIdentityCustom.Models.TeacherDomaines", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASP.NETCoreIdentityCustom.Models.Project", b =>
                {
                    b.HasOne("ASP.NETCoreIdentityCustom.Areas.Identity.Data.ApplicationUser", "ApplicationUser")
                        .WithOne("Project")
                        .HasForeignKey("ASP.NETCoreIdentityCustom.Models.Project", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP.NETCoreIdentityCustom.Models.Domaine", "Domaine")
                        .WithMany()
                        .HasForeignKey("DomaineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP.NETCoreIdentityCustom.Areas.Identity.Data.ApplicationUser", "Teacher")
